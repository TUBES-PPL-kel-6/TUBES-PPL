...
<body>
    @if(Auth::check() && Auth::user()->role === 'admin')
        <div class="sidebar">
            ...
            <a href="{{ route('loan.approval') }}" class="active">Persetujuan Pinjaman</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <a href="{{ route('loan.show', $loan->id) }}" class="btn btn-sm btn-outline-primary">Detail</a>
                                            @if($loan->status == 'pending')
                                            <form action="{{ route('loan.approve', $loan->id) }}" method="POST" class="d-inline">
                                                @csrf
                                                <button type="submit" class="btn btn-sm btn-outline-success">Setujui</button>
                                            </form>
                                            <form action="{{ route('loan.reject', $loan->id) }}" method="POST" class="d-inline">
                                                @csrf
