...
<body class="flex bg-gray-50 text-gray-800 font-sans">
    ...
    <aside id="sidebar" class="w-64 bg-primary text-white min-h-screen flex flex-col fixed shadow-lg z-10 transition-all duration-300 ease-in-out">
        ...
        <div class="flex-1 px-2 pt-6 space-y-1">
            ...
            <a href="#" class="flex items-center gap-3 py-3 px-4 rounded-lg hover:bg-white/20 transition {{ request()->routeIs('user.riwayat-simpanan.*') ? 'active' : '' }}">
                <i class="fas fa-history"></i> <span class="sidebar-text">Riwayat Simpanan</span>
            </a>
            ...
            <a href="{{ route('user.riwayat-pinjaman.index') }}" class="flex items-center gap-3 py-3 px-4 rounded-lg hover:bg-white/20 transition {{ request()->routeIs('user.riwayat-pinjaman.*') ? 'active' : '' }}">
                <i class="fas fa-history"></i> <span class="sidebar-text">Riwayat Pinjaman</span>
            </a>
            <!-- END Menu Utama -->
